...
namespace TAG.Payments.Template
{
	...
	public class Service : IBuyEDalerService, ISellEDalerService, IPaymentService
	{
		...
		/// Icon URL
		/// </summary>
		public string IconUrl => Gateway.GetUrl("/Template/Images/Everaldo-Crystal-Clear-Mimetype-vector-gfx.128.png"); // TODO: Replace to a correct representation of the service.
